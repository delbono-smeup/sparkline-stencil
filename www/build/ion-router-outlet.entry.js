import { r as registerInstance, d as getIonMode, e as createEvent, c as config, h, f as getElement } from './core-ac546284.js';
import { a as attachComponent, d as detachComponent } from './framework-delegate-edc3d751.js';
import { t as transition } from './index-ac56e8a4.js';
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        this.gesture = (await __sc_import_app('./swipe-back-f1625998.js')).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
