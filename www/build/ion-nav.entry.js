import { r as registerInstance, e as createEvent, B as Build, d as getIonMode, c as config, h, f as getElement } from './core-ac546284.js';
import { a as attachComponent } from './framework-delegate-edc3d751.js';
import { l as lifecycle, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE, t as transition, s as setPageHidden } from './index-ac56e8a4.js';
import { b as assert } from './helpers-6ef17316.js';
...
const Nav = class {
    ...
    async componentDidLoad() {
        this.rootChanged();
        this.gesture = (await __sc_import_app('./swipe-back-f1625998.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
